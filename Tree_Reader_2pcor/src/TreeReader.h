...
public:
	...
	void set_2pcor_bins(int bins, double x_low, double x_high);
...
private:
	// Attributes
	map<int, map<int, TH1D>> data; //2pcor[centrality][num particles in event]
	...
	string twopcorr_out_name = "Twopcorr_";
