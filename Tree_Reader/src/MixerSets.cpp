...
int MixerSets::get_max_events() {
	return(max_events);
}

bool MixerSets::get_use_leftover() {
	return(use_leftover);
}

string MixerSets::get_out_path() {
	return(out_path);
}

vector<int> MixerSets::get_divs() {
	return(divs);
}
...
void MixerSets::set_max_events(int max_events) {
	this->max_events = max_events;
}

void MixerSets::set_use_leftover(bool use_leftover) {
	this->use_leftover = use_leftover;
}

void MixerSets::set_out_path(string path) {
	this->out_path = path;
}

void MixerSets::set_divs(vector<int> divs) {
	this->divs = divs;
}
...
void MixerSets::append_event(vector<double> angles, int ref_mult2) {
...
void MixerSets::mix_set(int ref_mult2) {
...
void MixerSets::write_mixed_data() {
	if(use_leftover) {
