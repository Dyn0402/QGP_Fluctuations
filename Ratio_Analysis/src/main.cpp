...
//	analyzer.set_out_root_name("10-2-20_binom_BES1_eta_05_1_dca_1_3.root");
	analyzer.set_out_root_name("10-14-20_binom_Sim_Stats.root");
	analyzer.set_energies({7, 11, 19, 27, 39, 62});
